                        ...
                        <div className="flex w-[50%] flex-col items-center">
                            ...
                            <div className='flex w-full items-center justify-center'>
                                <button onMouseEnter={preMusic} className="px-4 py-2 rounded-md">
                                    <img className="h-16 rounded-lg transition-all -rotate-45 hover:rotate-0 duration-500" src="src/components/images/Previous.png" alt="Previous" />
                                </button>

                                {isPlaying ? (
                                    <button onClick={pauseMusic} className="px-4 py-2 rounded-md">
                                        <img className="h-20 hover:h-24 rounded-lg transition-all duration-500" src="src/components/images/Pause.png" alt="Pause" />
                                    </button>
                                ) : (
                                    <button onClick={playMusic} className="px-4 py-2 rounded-md">
                                        <img className="h-20 hover:h-24 rounded-lg transition-all duration-500" src="src/components/images/Play2.png" alt="Play" />
                                    </button>
                                )}

                                <button onMouseEnter={nxtMusic} className="px-4 py-2 rounded-md">
                                    <img className="h-16 rounded-lg transition-all rotate-45 hover:rotate-0 duration-500" src="src/components/images/Next.png" alt="Next" />
                                </button>
                            </div>
                        ...
                        <div className='flex flex-col rounded-xl w-[50%] items-center'>
                            <div className="flex rounded-xl items-center space-x-2 mt-4">
                                <button onClick={shuffleMusic} className="px-4 py-2">
                                    <img className="h-14 hover:h-16 rounded-lg hover:-rotate-180 transition-all duration-500" src="src/components/images/Shuffle.png" alt="Shuffle" />
                                </button>

                                <button onClick={restartMusic} className="px-4 py-2">
                                    <img className="h-14 hover:h-16 rounded-lg transition-all hover:rotate-180 duration-500" src="src/components/images/Restart.png" alt="Restart" />
                                </button>
                            </div>
                            <div className="mt-4 ">
                                <input
